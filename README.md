...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/scikit_sundae-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/scikit_sundae-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add scikit-sundae
# for installing globally
pixi global install scikit-sundae
```
...
It is possible to list all of the versions of `scikit-sundae` available on your platform:
...
```
pixi search scikit-sundae --channel conda-forge
```
